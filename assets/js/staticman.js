    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $("#comment-form .js-notice")
          ...
          .addClass("success");
        showAlert(
          '<strong>Thanks for your comment!</strong> It is <a href="https://github.com/chris42/christiansaga.de/pulls">currently pending</a> and will show on the site once approved.'
        );
      },
      error: function(err) {
        console.log(err);
